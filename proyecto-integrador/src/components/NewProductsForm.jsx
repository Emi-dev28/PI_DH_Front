...
export const NewProductsForm = ({ newProduct, setNewProduct, submitAgregarProducto, subirImagenInput }) => {
        ...
        <div className="flex justify-center pt-4">
            ...
            <div className="w-1/2 flex flex-col items-center">
                ...
                <div className="flex gap-x-2">
                    ...
                    <div>
                        <img src="/img/contactus2.png" alt="" className="h-[420px] mt-6 border-0 rounded-xl" />
                    </div>
