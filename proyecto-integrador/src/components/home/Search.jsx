    ...
    <search className="mt-10 flex flex-col items-center justify-center gap-8 sm:flex-row">
      ...
      <div className="flex items-center">
        ...
        <Input
          ...
          className="h-10 w-[273px] rounded-2xl border bg-gray-100 pl-10 pr-8 shadow-md transition-all duration-300 ease-in-out hover:border-gray-400 focus:border-none lg:w-[360px]"
        />
      </div>
