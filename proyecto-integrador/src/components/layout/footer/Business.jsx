...
const Business = () => {
  ...
  return (
    ...
    <div style={{ textAlign: 'center' }}>
        ...
        <h1 className='py-8 font-bold text-red-500 text-3xl'>¿TENES UNA EMPRESA?, MIRA!</h1>
    </div>
    
        <div className='ml-8 py-12'>
          <p className="text-2xl font-bold">ALQUILA LA MEJOR TECNOLOGIA<br />PARA TU NEGOCIO</p>
        </div>
        ...
        <div className='flex justify-end items-end mr-8 py-12 text-end'>
          <p className="text-2xl font-bold">SERVICIOS COMPLETOS <br />A TU MEDIDA</p>
        </div>
